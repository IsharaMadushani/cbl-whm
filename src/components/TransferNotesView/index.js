    ...
    <div className={classes.root}>
      <AppBar position="static" color="default">
        <Tabs
          ...
          variant="fullWidth"
        >
          <Tab label="Finished Goods Transfer Notes" {...a11yProps(0)} />
          <Tab label="Inventory Transfer Notes" {...a11yProps(1)} />
        </Tabs>
      </AppBar>
      <SwipeableViews
...
export default withAuthorization(condition)(TranferNotesView);